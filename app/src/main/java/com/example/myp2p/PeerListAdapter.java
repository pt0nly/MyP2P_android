...
public class PeerListAdapter extends RecyclerView.Adapter<PeerListAdapter.ViewHolder> {
    ...
    public PeerListAdapter(List<DeviceDTO> devices, PeerListFragment.OnListFragmentInteractionListener listener) {
        mDevices = devices;
        mListener = listener;
    }
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        holder.mContentView.setText(mDevices.get(position).getPlayerName() + "-" + mDevices.get(position).getDeviceName());
