...
import com.example.myp2p.wifidirect.WiFiDirectBroadcastReceiver;
        ...
        if (!isWDConnected) {
            ...
            wifiP2pManager.discoverPeers(wifip2pChannel, new WifiP2pManager.ActionListener() {
                ...
                public void onFailure(int reasonCode) {
                    NotificationToast.showToast(LocalDashWiFiDirect.this, "Peer discovery failure: " + reasonCode);
                }
            });
        }
    }
        ...
        public void onReceive(Context context, Intent intent) {
            switch (intent.getAction()) {
                ...
                case DataHandler.DEVICE_LIST_CHANGED:
                    ArrayList<DeviceDTO> devices = DBAdapter.getInstance(LocalDashWiFiDirect.this).getDeviceList();
